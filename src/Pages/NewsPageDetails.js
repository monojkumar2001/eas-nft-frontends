...
const NewsPageDetails = () => {
  ...
  const id = useParams();
  console.log("id", id);
  const singleData = newsData.filter((res) => res.slug === id.id);
        ...
        <div className="container">
          ...
          <div className="post-top-area">
            <div className="post-top-content">
              <h1 className="urbanist-dark-22">{singleData[0].title}</h1>
            ...
            <div className="small-info">
              <div>
                ...
                <p className="urbanist-grey-15">{singleData[0].newsCreator}</p>
              </div>
              <div>
                <svg
                  width="14"
                ...
                <p className="urbanist-grey-15">{singleData[0].date}</p>
              </div>
            </div>
          </div>
...
const newsData = [
  {
    ...
    img:"/images/addressnfts/nft.webp",
    date:'Jone 5, 2023',
    ...
    description: `Ethereum Address Ethereum Address Service (“EAS”) is thrilled to announce the launch of its ground-breaking platform where the world’s addresses are being mapped as NFT-based digital rights. EAS NFTs are the Service (“EAS”) is thrilled to announce the launch of its ground-breaking platform where the world’s addresses are being mapped as NFT-based digital rights. EAS NFTs are the keys to unlock value in the digital world. With EAS, NFT collectors participate in the monetization of exclusive content that is associated with an individual address. William Corbett, Founder of EAS, said, “We envision a future where every real-world address and point of interest has an associated EAS NFT...Ethereum Address Service (“EAS”) is thrilled to announce the launch of its ground-breaking platform where the world’s addresses are being mapped as NFT-based digital rights. EAS NFTs are the keys to unlock value in the digital world. With EAS, NFT collectors participate in the monetization of exclusive content that is associated with an individual address. William Corbett, Founder of EAS, said, “We envision a future where every real-world address and point of interest has an associated EAS NFT.....`,
  },
];
